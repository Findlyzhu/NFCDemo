...
SKF_FUN_INFO(V_ExportSessionKeyByHandle, (HANDLE hSessionKey,HANDLE hWrapKey,u8 *pbData, u32 *pulDataLen));
SKF_FUN_INFO(V_DigestUpdateKey, (HANDLE hHash,HANDLE hKey));
SKF_FUN_INFO(V_EncryptAndDigestUpdate, (HANDLE hKey,HANDLE hHash,u8 *data, u32 len,u8 *endata,u32 *enlen));
SKF_FUN_INFO(V_DecryptAndDigestUpdate, (HANDLE hKey,HANDLE hHash,u8 *endata, u32 enlen,u8 *data,u32 *len));
SKF_FUN_INFO(V_FPMatch, (HAPPLICATION hApplication, u32 *pulRetry));
SKF_FUN_INFO(V_GetFPTouchedState, (HAPPLICATION hApplication, u32 *pulTouched));
...
#define SKF_DEF_FUN_T(name) __PASTE(P_,name)	name
	...
	SKF_DEF_FUN_T(V_ExportSessionKeyByHandle);
	SKF_DEF_FUN_T(V_DigestUpdateKey);
	SKF_DEF_FUN_T(V_EncryptAndDigestUpdate);
	SKF_DEF_FUN_T(V_DecryptAndDigestUpdate);
	SKF_DEF_FUN_T(V_FPMatch);
	SKF_DEF_FUN_T(V_GetFPTouchedState);
#ifdef ANDROID
	SKF_DEF_FUN_T(V_SetDevRes);
#endif
#undef SKF_DEF_FUN_T
